...
void test_4(void)
{
    ...
    TEST_ASSERT_EQUAL_MESSAGE(valid_output, output, "test_4 failed");
}

void test_5(void)
{
    char valid_output = 25;
    char input = 20;
    char output = 0;
    ...
    TEST_ASSERT_EQUAL_MESSAGE(valid_output, output, "test_5 failed");
}
