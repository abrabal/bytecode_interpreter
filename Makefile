...
TARGETS = bin/test/test_vm.elf bin/dump_program.elf bin/sandbox.elf bin/code_generator.elf bin/tasks/task1_add_five.elf bin/tasks/task_2_find_match.elf
...
SRCS_TASK_ADD_FIVE =  tasks/task1_add_five/add_five.c vm.c third_party/unity/unity.c code_parser.c
...
bin/tasks/task1_add_five.elf: $(SRCS_TASK_ADD_FIVE)
	$(CC) $(CFLAGS) $^ -o $@
